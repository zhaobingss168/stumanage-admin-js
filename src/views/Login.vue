  ...
  <div>
    ...
    <span class="tool-bar">
      ...
      <el-form-item>
        ...
        <el-col :span="9">
          <el-form-item>
            <img style="width: 100%;" class="pointer" :src="showVerify" @click="refreshCaptcha">
          </el-form-item>
        </el-col>
      </el-form-item>
  ...
  export default {
    ...
    data() {
      return {
        ...
        checked: true,
        showVerify: this.global.baseUrl + "/captcha.jpg" // 图形验证码
      }
    },
    methods: {
      // 登录
      ...
      refreshCaptcha: function () {
        this.showVerify = this.global.baseUrl + "/captcha.jpg?ran=" + +Math.random()
      },
      reset() {
